...
<template>
    <div class="bg-white">
      <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <p class="inline text-3xl font-bold tracking-tight text-indigo-600 sm:block sm:text-4xl">
          {{block.headline2}}
        </p>
        <form class="mt-8 sm:flex">
          <label for="email-address" class="sr-only">{{block.label_text}}</label>
          ...
          <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            ...
            class="flex w-full items-center justify-center rounded-md border border-transparent
             bg-indigo-600 px-5 py-3 text-base font-medium text-white
